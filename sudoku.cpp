...
void Sudoku::changeRow(int rowset1, int rowset2){
	...
	if(rowset1<0||rowset1>2||rowset2<0||rowset2>2){
		exit;}
	else{
		switch(rowset){
...
void Sudoku::changeCol(int colset1, int colset2){
	...
	if(colset1<0||colset1>2||colset2<0||colset2>2){
		exit;}
	else{
		if(colset1>colset2){swap=colset1;colset1=colset2;colset2=swap;}
		switch(colset){
